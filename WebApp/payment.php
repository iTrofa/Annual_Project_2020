...
{
    return !(!is_string($service) || (preg_match('/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/', $service) !== 1));
}
...
<main>
    ...
    <div class="row py-5 p-4 bg-white rounded shadow-sm" style="margin-left: 0;margin-right: 0">
        <div class="col-lg-6">
            ...
            <div class="p-4">
                ...
                <div class="input-group mb-4 border rounded-pill p-2">
                    <select type="text" placeholder="Apply coupon" aria-describedby="button-addon3"
        ...
        <div class="col-lg-6">
            ...
            <div class="p-4">
                <p class="font-italic mb-4">Tax costs are calculated based on values you have entered and each
                    service.</p>
                <ul class="list-unstyled mb-4">
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Order
                            Subtotal </strong><strong><?= $price . "€" ?></strong></li>
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                class="text-muted">Tax</strong><strong><?= $price * 0.21 . "€" ?></strong></li>
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong
